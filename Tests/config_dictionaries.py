...
distributions_to_test.append({'dist'      :CompleteLinearModel,
                              'tolerance':1e-01})

distributions_to_test.append({'dist'      :Delta,
                              'tolerance':1e-01})

distributions_to_test.append({'dist'      :Dirichlet,
                              'support'  : (0,1),
                              'tolerance':1e-01})
...
distributions_to_test.append({'dist'      :Histogram,
                              'tolerance':1e-01})
...
distributions_to_test.append({'dist'      :Transformed,
                              'tolerance':1e-01})

distributions_to_test.append({'dist'      :Truncated,
                              'tolerance':1e-01})
